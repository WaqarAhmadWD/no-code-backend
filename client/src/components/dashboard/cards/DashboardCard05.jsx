...
function DashboardCard05() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 md:col-span-7 lg:col-span-8 bg-white shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 flex items-center">
        <h2 className="font-semibold text-gray-800 text-xs text-gray-800">Investment</h2>
      <div>
