...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label
        className="flex items-center justify-center cursor-pointer w-8 h-8 hover:bg-gray-100 lg:hover:bg-gray-200 rounded-full"
      ...
      >
        ...
        <svg
          className="hidden fill-current text-gray-500/80"
          width={16}
          height={16}
          viewBox="0 0 16 16"
          xmlns="http://www.w3.org/2000/svg"
