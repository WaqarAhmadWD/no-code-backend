...
function DropdownFilter({ align }) {
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className="btn px-2.5 bg-white border-gray-200 hover:border-gray-300 text-gray-400"
        aria-haspopup="true"
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className={`origin-top-right z-10 absolute top-full left-0 right-auto min-w-56 bg-white border border-gray-200 pt-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${
          align === "right"
      ...
      >
        <div ref={dropdown}>
          <div className="text-xs font-semibold text-gray-400 uppercase pt-1.5 pb-2 px-3">
            Filters
          </div>
          <ul className="mb-4">
            ...
            <ul className="flex items-center justify-between">
              <li>
                <button
                  ...
                  className="btn-xs bg-white border-gray-200  hover:border-gray-300 text-red-500"
                >
                  Clear
                </button>
              </li>
              <li>
                <button
                  className="btn-xs bg-gray-900 text-gray-100 hover:bg-gray-800"
