...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 text-gray-600", className)}
      classNames={{
        ...
        weekdays: "flex",
        weekday:
          "text-gray-400 font-medium rounded-md w-9 text-[0.8rem]",
        ...
        outside:
          "day-outside text-gray-400 aria-selected:bg-violet-500/50 aria-selected:text-gray-400",
