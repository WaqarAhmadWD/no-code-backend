     ...
     const handleAdd = async () => {
      ...
      const limit = parseInt(localStorage.getItem("limit") || 10);
        const result = await dispatch(
          fetchData({ url: `/investor/create`, method: "POST", data: {...formDataAdd,last_level_id:last_level},refresh:["/investor/get/lists",`/investor/get?limit=${limit}&offset=0&search=`] })
        ).unwrap();
        if (!result?.error) {
