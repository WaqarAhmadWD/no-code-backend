...
function UserRole({permissions,outsider}) {
  const [data, setData] = useState([]);
  const dispatch = useDispatch()
const childRef = useRef();;
  const name = "Investors/Customer";
  const module = "investor";
        ...
        <div className=" px-4 sm:px-6 lg:px-5 py-5 r w-full max-w-9xl mx-auto">
          <div className="bg-white py-5  rounded-md shadow-md">
            <div className="flex flex-col md:flex-row items-center justify-between px-3">
              ...
              {!outsider && <div className="flex flex-col md:flex-row items-center justify-end gap-2">
                ...
                {permissions("do_create") && <Link className="basis-1/1" to="/investor-add">
                  <button
                    type="button"
                ...
                <table className="min-w-full table-auto">
                  ...
                  <thead className="">
                    <tr className=" blue-bg text-white capitalize">
                      ...
                      {(permissions(["do_edit","do_delete"]) && !outsider) && <th className="py-2 text-xs px-6 text-center">Actions</th>}
                    </tr>
                  </thead>
                    ...
                    {data.length > 0 ? (
                      data.map((item, index) => (
                        ...
                        >
                          ...
                          {(permissions(["do_edit","do_delete"]) && !outsider) && <td className="py-3 px-6 text-left text-xs text-black">
