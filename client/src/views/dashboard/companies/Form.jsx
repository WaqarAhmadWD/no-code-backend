     ...
     const handleAdd = async () => {
      const limit = parseInt(localStorage.getItem("limit") || 10);
        const result = await dispatch(
          fetchData({ url: `/company/create`, method: "POST", data: {...formDataAdd,last_level_id:last_level},refresh:["/company/get/lists",`/company/get?limit=${limit}&offset=0&search=`] })
        ).unwrap();
        if (!result?.error) {
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <input
                    ...
                    id="tax_id"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="Tax Id ex. 97-3456773"
                ...
                <div>
                  <input
                    ...
                    value={formDataAdd.data_created}
                    onChange={(e) =>
                      setFormDataAdd({
                        ...formDataAdd,
